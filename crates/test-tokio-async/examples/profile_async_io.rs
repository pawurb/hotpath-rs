...
//! ```bash
//! cargo run -p test-tokio-async --example profile_async_io --features hotpath --profile profiling
//! ```
//!
//! Profile with samply:
//! ```bash
//! cargo build -p test-tokio-async --example profile_async_io --profile profiling
