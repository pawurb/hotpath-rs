...
pub mod tests {
    ...
    fn test_iter_output() {
        ...
        let sep = path_sep();
        let iter_24 = format!("examples{sep}iter_asc.rs:24");
        let iter_24_2 = format!("examples{sep}iter_asc.rs:24-2");
        let iter_24_3 = format!("examples{sep}iter_asc.rs:24-3");
        let iter_37 = format!("examples{sep}iter_asc.rs:37");
        let iter_37_2 = format!("examples{sep}iter_asc.rs:37-2");
        let iter_37_3 = format!("examples{sep}iter_asc.rs:37-3");
        let all_expected = [
            iter_24.as_str(),
            iter_24_2.as_str(),
            iter_24_3.as_str(),
