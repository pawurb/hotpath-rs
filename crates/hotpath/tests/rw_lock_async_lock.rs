...
pub mod tests {
    ...
    fn test_basic_output() {
        let output = Command::new("cargo")
            .args([
                "run",
                "-p",
                "test-rw-lock-async-lock",
                "--example",
                "basic_rw_lock_async_lock",
                "--features",
                "hotpath",
            ])
            .output()
        ...
        let all_expected = [
            "async-lock RwLock example completed!",
            "rw_locks",
            "counter",
            "Reads",
            "Writes",
    ...
    // cargo run -p test-rw-lock-async-lock --example basic_rw_lock_async_lock --features hotpath (json)
    #[test]
    fn test_json_output() {
        let output = Command::new("cargo")
            .args([
