...
pub(crate) fn render_inspect_popup(entry: &InspectedFunctionLog, area: Rect, frame: &mut Frame) {
    ...
    let block = Block::bordered()
        .title(format!(
            " Result (Call #{}, Mem: {}, Ago: {}, TID: {}) ",
            entry.invocation_index, entry.value, entry.ago, tid_str
        ))
